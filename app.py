...
@st.cache_resource
def load_model():
    model = joblib.load(r"C:\Users\kasoj\OneDrive\Desktop\Logistic_Regression\logistic_regression_model.pkl")
    return model

# Load the dataset to get feature names
@st.cache_resource
def load_data():
    df = pd.read_csv(r"C:\Users\kasoj\Downloads\heart.csv")
    return df
...
try:
    ...
    st.error(f"❌ Error: {e}")
    st.info(r"Make sure the model file is saved at:C:\Users\kasoj\OneDrive\Desktop\Logistic_Regression\logistic_regression_model.pkl")
